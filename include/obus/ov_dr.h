...
#define MAX_FILES_IN_ONE_PARSE		128
...
int dr_create_metalib_multifile(LPDRMETALIB* ppstLib, const char* aszFile[], int iFile, FILE* fpError);
...
int dr_metalib_to_hpp_spec(LPDRMETALIB pstLib, const char* pszXml, const char* pszHpp, const char* pszLeading, FILE* fpError);
