...
class MainFrame(wx.Frame):
    ...
    def __init__(self):
        ...
        wx.Button(controlPanel, -1, '增加结点', (10, 130)).Bind(wx.EVT_BUTTON, self.onInsert)
        wx.Button(controlPanel, -1, '删除结点', (90, 130)).Bind(wx.EVT_BUTTON, self.onDelete)
        wx.Button(controlPanel, -1, '保存修改', (170, 130)).Bind(wx.EVT_BUTTON, self.onSave)

        wx.Button(controlPanel, -1, '向上移动', (10, 160)).Bind(wx.EVT_BUTTON, self.onMoveUp)
        wx.Button(controlPanel, -1, '向下移动', (90, 160)).Bind(wx.EVT_BUTTON, self.onMoveDown)
        wx.Button(controlPanel, -1, '发布节点', (170, 160)).Bind(wx.EVT_BUTTON, self.onPublishDocument)
