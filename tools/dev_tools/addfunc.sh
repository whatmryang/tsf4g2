...
#  @file $RCSfile: addfunc.sh,v $
#  general description of this module
#  $Id: addfunc.sh,v 1.1.1.1 2008-05-28 07:34:59 kent Exp $
#  @author $Author: kent $
...
if [ $# -eq 0 ] ; then
	...
	echo "	  You can use this command to add a function comment to  source files."
	exit 0
fi
...
{
	cat $1 >> $2;
	echo "Use template '$1' for generate function for '$2' success.";
}
