...
TTransCSharp::makeTdrBuf()
{
    ...
    APPEND_CSHARP_CONTAINER("{");
    {
        loadCodeRes(0,  Lines, bufCode,
            sizeof(TTransCSharp::bufCode)/sizeof(TTransCSharp::bufCode[0]));
    }

    APPEND_CSHARP_CONTAINER("}");
    OUTPUT_CSHARP_CONTAINER_NOMETA("TdrBuf.cs");
}
