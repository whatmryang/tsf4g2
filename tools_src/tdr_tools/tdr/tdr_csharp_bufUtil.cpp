...
const char * TTransCSharp::bufUtilCode[] = {
    "",
    "",
...
TTransCSharp::makeTdrBufUtil()
{
    ...
    APPEND_CSHARP_CONTAINER("{");
    {
        loadCodeRes(0,  Lines, bufUtilCode, 
            sizeof(TTransCSharp::bufUtilCode)/sizeof(TTransCSharp::bufUtilCode[0]));
    }

    APPEND_CSHARP_CONTAINER("}");
    OUTPUT_CSHARP_CONTAINER_NOMETA("TdrBufUtil.cs");
}
